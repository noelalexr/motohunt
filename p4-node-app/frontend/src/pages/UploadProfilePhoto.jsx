    ...
    return (
        <div className="min-h-screen flex justify-center items-center p-8">
            <form onSubmit={handleSubmit} className="relative flex flex-col gap-3 bg-white/60 md:py-15 py-10 md:px-20 px-12 text-center rounded-lg">
                <div onClick={() => navigate("/profile")} className="absolute top-14 md:left-5 left-2 rounded-full text-[#990000] p-3 hover:bg-[#990000] hover:text-white ease-in-out duration-300 cursor-pointer">
